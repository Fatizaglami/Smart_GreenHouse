...
public class ShowInfosLight implements Initializable {
	public int id_c;
    ...
    public void showInfosLight() throws SQLException {
    	String sql = "SELECT * FROM stockcapteur WHERE type_capteur= 'lumiere'";
    ...
    public void addToCart() throws SQLException {
    	String 	sql1=" select id_p from personne where CIN='"+cinTextField.getText()+"'";
    	 ...
    	 String	sql2="SELECT qté from stockcapteur where type_capteur='lumiere' ";
