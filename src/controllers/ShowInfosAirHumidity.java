...
public class ShowInfosAirHumidity implements Initializable {
	public int id_c;
    ...
    public void showInfosAir() throws SQLException {
    	String sql = "SELECT * FROM stockcapteur WHERE type_capteur= 'humidityAir'";
    ...
    public void addToCart() throws SQLException {
    	String 	sql1=" select id_p from personne where CIN='"+cinTextField.getText()+"'";
    	 ...
    	 String	sql2="SELECT qté from stockcapteur where type_capteur='humidityAir' ";
